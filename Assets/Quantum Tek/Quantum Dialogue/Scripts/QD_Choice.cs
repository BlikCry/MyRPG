...
namespace QuantumTek.QuantumDialogue
{
    ...
    public class QD_Choice
    {
        ...
        public bool IsQuestNode => QuestData != null;

        public string AcceptMessage;
        public string DenyMessage;
        public int NotAcceptedNode => NextMessages[0];
        public int AcceptedNode => NextMessages[1];
        public int DoneNode => NextMessages[2];
        public int CompleteNode => NextMessages[3];
